...
<div style="background-color:rgb(194, 185, 108);color: white;padding: 26px;width: 80%">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" name="kode_barang" value="<?=$row[0]?>" readonly />
  </div>
  <div class="col-md-6">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" name="harga"value="<?=$row[2]?>"/>
  </div>
  <div class="col-md-6">
    <label for="gambar" class="form-label">Gambar</label>
    <input type="text" name="gambar" class="form-control"value="<?=$row[3]?>"/>
  </div>
  <div class="col-md-6">
    <label for="jml_stok" class="form-label">Jumlah Stok</label>
    <input type="text" class="form-control" name="jml_stok"value="<?=$row[4]?>"/>
  </div>
    <br>
...
<?php
    ...
    echo "<meta http-equiv=refresh content=1;URL='indexbrg.php'>";  
}
?>
